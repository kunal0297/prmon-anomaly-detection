...
The prototype implemented in this study demonstrates a basic anomaly detection workflow for software performance monitoring. Several extensions could further enhance the system and make it suitable for large-scale scientific computing environments such as those used by the ATLAS experiment.

Potential future improvements include:

# Real-time monitoring pipelines

Implementing online or streaming anomaly detection methods would allow monitoring data to be processed continuously as it is produced. This would enable near real-time identification of abnormal behaviour in running workflows.

# Advanced time-series modelling

Classical forecasting approaches such as ARIMA or state-space models could be used to model the expected behaviour of monitored metrics and detect deviations from predicted system performance.

# Deep learning-based anomaly detection

Sequence models such as LSTM networks could be applied to capture more complex temporal patterns in system metrics and detect subtle anomalies that may not be visible using simpler statistical methods.

# Large-scale distributed monitoring

In large computing infrastructures such as those used by ATLAS, monitoring data is generated by many parallel jobs. Future work could extend this prototype to analyse anomalies across large job populations and detect systemic performance regressions.

# Automated alerting and monitoring dashboards

Integrating anomaly detection with alerting systems and monitoring dashboards would allow developers to quickly identify and investigate performance regressions in production environments.

Automated monitoring systems of this type can significantly improve the ability to detect unexpected software behaviour early and help maintain efficient operation of large-scale scientific computing workflows.
